...
Now that we've signigicantly reduced our sample size, let's see if we can split the data into male and female. You can still keep it in one table for now.
